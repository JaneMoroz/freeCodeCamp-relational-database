...
echo "$($PSQL "SELECT year, name FROM teams FULL JOIN games ON teams.team_id=games.winner_id WHERE winner_goals > opponent_goals AND round='Final' ORDER BY year")"
